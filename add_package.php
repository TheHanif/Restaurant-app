...
<form class="form-horizontal" action="" method="post">
	<div class="col-sm-6">
		  <div class="form-group">
		    ...
		    <div class="col-sm-8">
		      <input type="text" class="form-control" name="package_unique_id" id="package_unique_id" value="<?php echo (isset($ID))? $package_result->package_unique_id : '123' ?>" placeholder="Id" readonly>
		    </div>
		  </div>
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-8">
		      <input type="text" class="form-control" name="package_name" id="package_name" value="<?php echo (isset($ID))? $package_result->package_name : '' ?>" placeholder="Name">
		    </div>
		  </div>
